...
allowed-tools: Bash(bd:*) Bash(flow-*) Bash(cat:*) Bash(grep:*) Bash(head:*) Bash(tail:*) Bash(cut:*) Bash(tr:*) Bash(wc:*) Bash(echo:*) Bash(ls:*) Bash(cd:*) Bash(jq:*)
---
...
```bash
flow-link-doc {task-id} Plan {plan-path}
```
